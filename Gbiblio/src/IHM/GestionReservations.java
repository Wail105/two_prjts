...
public class GestionReservations extends javax.swing.JDialog {
    ...
    public void identifiantUsagerComboActionPerformed(ActionEvent evt) {
        try {
    ...
    public void reserver(ActionEvent evt) {
    ...
    public void annulerBoutonActionPerformed(ActionEvent evt) {
        this.dispose();
    }

    private String titre;

	public JComboBox<?> getIdentifiantUsagerCombo() {

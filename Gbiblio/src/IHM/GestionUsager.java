...
public class GestionUsager extends JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        panRecherch.setBackground(new Color(214, 214, 214));
        ...
        panListeUsager.setBackground(new Color(214, 214, 214));
        ...
        telLabel.setForeground(new Color(0, 0, 0));
        ...
        prenomLabel1.setForeground(new Color(0, 0, 0));

...
public class GestionReservationsEmprunts extends JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new Color(214, 214, 214));

        mainPanel.setBackground(new Color(214, 214, 214));
        mainPanel.setLayout(new CardLayout());

        EmpruntPanel.setBackground(new Color(214, 214, 214));

        panEmpCours.setBackground(new Color(214, 214, 214));
        panEmpCours.setBorder(BorderFactory.createTitledBorder("Emprunts en cours des exempalaires de l'oeuvre"));

        jScrollPane1.getViewport().setBackground(Color.white);
        jScrollPane1.setBackground(new Color(214, 214, 214));
        ...
        menuEmpPanel.setBackground(new Color(214, 214, 214));
        ...
        panExemplaires.setBackground(new Color(214, 214, 214));
        panExemplaires.setBorder(BorderFactory.createTitledBorder("Exemplaires Disponibles"));

        jScrollPane2.getViewport().setBackground(Color.white);
        jScrollPane2.setBackground(new Color(214, 214, 214));
        ...
        ReservationPanel.setBackground(new Color(214, 214, 214));

        panResaCours.setBackground(new Color(214, 214, 214));
        ...
        jScrollPane5.setBackground(new Color(214, 214, 214));
        ...
        menuResaPanel.setBackground(new Color(214, 214, 214));
